...
export default function UpdateProfile() {
  ...
  return (
    <div className={`${styles.update}`}>
      ...
      <input
      className="rounded-2xl bg-black text-white border border-white px-4 py-2"
        type="text"
        value={username}
      ...
      />
      <button className="mt-4 bg-white text-black rounded-2xl hover:bg-gray-700 hover:text-white" onClick={update}>Update profile</button>
    </div>
  );
}